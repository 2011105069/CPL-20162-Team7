...
public class SubActivity_06 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_06);
        ...
        Log.w("act6","2222222222222222222");

        int a=0, b=0;

        // 21 is 21 meals in a week.
        for(a=0; a<21; a++) {
            tmp = cc[a].split("_");
...
//            Log.w("here",String.valueOf(tmp[8]));
        ...
        Log.w("act6", "333333333333333333333");
        for(b=0; b<9;b++) {
            nut[b]=nut[b]/86;
        }

        for(b=0; b<9;b++) {
            Log.w("act6",String.valueOf(nut[b]));
        }

        Log.w("act6", "44444444444444444444444");
    ...
    {
        Intent intent_02 = new Intent(getApplicationContext(), SubActivity_07.class);
